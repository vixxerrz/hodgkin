...
class AbsenceTracker:
    ...
    def load_teacher_data(self):
        ...
        try:
            ...
            return [
                {"name": "Hafeeza", "absences": 12},
                {"name": "Krishna", "absences": 9},
                {"name": "Seema", "absences": 7},
                {"name": "Amjadh", "absences": 6},
                {"name": "Vinoth", "absences": 5},
                {"name": "Abraham", "absences": 4},
                {"name": "Anthony", "absences": 3},
                {"name": "Sumathi", "absences": 2},
                {"name": "Azima", "absences": 1}
            ]
    ...
    def create_widgets(self):
        ...
        subtract_btn.pack(side=tk.LEFT, padx=15)
